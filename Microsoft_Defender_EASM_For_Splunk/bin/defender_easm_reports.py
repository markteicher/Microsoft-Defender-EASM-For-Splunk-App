...
Responsibilities:
- Retrieve configured report definitions
...
class DefenderEASMReports(EASMModularInput):

    def collect(self):
        self.logger.info("Starting Defender EASM report collection")
        ...
        self.logger.info(
            f"Report ingestion complete — {total} report definitions ingested"
        )
