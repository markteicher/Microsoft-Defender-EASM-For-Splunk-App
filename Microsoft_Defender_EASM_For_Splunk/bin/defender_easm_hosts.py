...
Collects host assets from Microsoft Defender External Attack Surface Management.
"""
...
class DefenderEASMHosts(smi.Script):

    def get_scheme(self):
        scheme = smi.Scheme("Defender EASM Hosts")
        scheme.description = "Collect host assets from Microsoft Defender EASM"
        ...
        for input_name in inputs.inputs:
            try:
                ...
                ew.log(
                    ...
                    f"defender_easm_hosts failed: {e}\n{traceback.format_exc()}"
                )
...
if __name__ == "__main__":
    smi.ScriptRunner(DefenderEASMHosts).run()
